...
unsafe fn handle_browse(
    ...
    ManagedDNSServiceRef::default().resolve_service(
        ServiceResolveParams::builder()
            .flags(bonjour_sys::kDNSServiceFlagsForceMulticast as u32)
...
unsafe fn handle_get_address_info(
    ...
    let ip = {
        let address = address as *const bonjour_sys::sockaddr_in;
        assert_not_null!(address);
        let s_addr = (*address).sin_addr.S_un.S_addr.to_le_bytes();
